...
import javax.swing.Timer;
	...
	public class GAME3 extends JFrame implements ActionListener 
	{
		...
		ImageIcon star, iplayer1_1, iplayer1_2, iplayer1_3, iplayer1_4, iplayer2_1, iplayer2_2, iplayer2_3, iplayer2_4,
		                iplayer3_1, iplayer3_2, iplayer3_3, iplayer3_4, iplayer4_1, iplayer4_2, iplayer4_3, iplayer4_4;
		
		int moves = 0;
		int randomnum;
		
		JLabel label,runnerlabel;
		...
		boolean player1_1 = false;
		boolean player1_2 = false;
		boolean player1_3 = false;
		boolean player1_4 = false;
		boolean player2_1 = false;
		boolean player2_2 = false;
		boolean player2_3 = false;
		boolean player2_4 = false;
		boolean player3_1 = false;
		boolean player3_2 = false;
		boolean player3_3 = false;
		boolean player3_4 = false;
		boolean player4_1 = false;
		boolean player4_2 = false;
		boolean player4_3 = false;
		boolean player4_4 = false;
		
		JButton dicebutton,runner1,runner2,runner3,runner4,newgame;

		int pos11 = 0,pos12 = 0,pos13 = 0,pos14 = 0;
		int pos21 = 0,pos22 = 0,pos23 = 0,pos24 = 0;
		int pos31 = 0,pos32 = 0,pos33 = 0,pos34 = 0;
		int pos41 = 0,pos42 = 0,pos43 = 0,pos44 = 0;
		
		boolean win11 = false,win12 = false,win13 = false,win14 = false;
		boolean win21 = false,win22 = false,win23 = false,win24 = false;
		boolean win31 = false,win32 = false,win33 = false,win34 = false;	
		boolean win41 = false,win42 = false,win43 = false,win44 = false;
		
		String first = "no",second = "no",third = "no",forth = "no";
		boolean start = false;
		int player1xpos[] =  {40, 80, 120,160,200,240,240,240,240,240,240,280,320,320,320,320,320,320,360,400,440,480,520,560,560,560,520,480,440,400,360,320,320,320,320,320,320,280,240,240,240,240,240,240,200,160,120, 80, 40,  0,  0, 40, 80,120,160,200,20};
		int player1ypos[] =  {280,280,280,280,280,240,200,160,120,80 ,40 ,40, 40, 80, 120,160,200,240,280,280,280,280,280,280,320,360,360,360,360,360,360,400,440,480,520,560,600,600,600,560,520,480,440,400,360,360,360,360,360,360,320,320,320,320,320,320,30};
		int player2xpos[] =  {320,320,320,320,320,360,400,440,480,520,560,560,560,520,480,440,400,360,320,320,320,320,320,320,280,240,240,240,240,240,240,200,160,120, 80, 40,  0,  0,  0, 40, 80,120,160,200,240,240,240,240,240,240,280,280,280,280,280,280,40};
		int player2ypos[] =  {80 ,120,160,200,240,280,280,280,280,280,280,320,360,360,360,360,360,360,400,440,480,520,560,600,600,600,560,520,480,440,400,360,360,360,360,360,360,320,280,280,280,280,280,280,240,200,160,120, 80, 40, 40, 80,120,160,200,240,50};
		int player3xpos[] =  {520,480,440,400,360,320,320,320,320,320,320,280,240,240,240,240,240,240,200,160,120, 80, 40,  0,  0,  0, 40, 80,120,160,200,240,240,240,240,240,240,280,320,320,320,320,320,320,360,400,440,480,520,560,560,520,480,440,400,360,60};
		int player3ypos[] =  {360,360,360,360,360,400,440,480,520,560,600,600,600,560,520,480,440,400,360,360,360,360,360,360,320,280,280,280,280,280,280,240,200,160,120, 80, 40, 40, 40, 80,120,160,200,240,280,280,280,280,280,280,320,320,320,320,320,320,70};
		int player4xpos[] =  {240,240,240,240,240,200,160,120, 80, 40,  0,  0,  0, 40, 80,120,160,200,240,240,240,240,240,240,280,320,320,320,320,320,320,360,400,440,480,520,560,560,560,520,480,440,400,360,320,320,320,320,320,320,280,280,280,280,280,280,80};
		int player4ypos[] =  {560,520,480,440,400,360,360,360,360,360,360,320,280,280,280,280,280,280,240,200,160,120, 80, 40, 40, 40, 80,120,160,200,240,280,280,280,280,280,280,320,360,360,360,360,360,360,400,440,480,520,560,600,600,560,520,480,440,400,90};
		ImageIcon img,img2;
		Font font;
	   //------------------------------------------------------------------------------------------------------------------------
		GAME3(String title)
...
//			newgame.setIcon(new ImageIcon("Webp.net-resizeimage (23).png"));
			...
			dicebutton.setIcon(new ImageIcon("GAME3_IMG\\dice.png"));
		...
		public void paint(Graphics g)
		{
			...
			blank = new ImageIcon("GAME3_IMG\\blankdice.png");
		
			img = new ImageIcon("GAME3_IMG\\Webp.net-resizeimage (1).jpg");
			...
			start = true;
			img2 = new ImageIcon("GAME3_IMG\\Webp.net-resizeimage (3).jpg");
			...
			star = new ImageIcon("GAME3_IMG\\star.png");
		...
		g.fillOval(55, 95,60, 60);
			...
			iplayer1_1 = new ImageIcon("GAME3_IMG\\redplayer.png");
			iplayer1_2 = new ImageIcon("GAME3_IMG\\redplayer.png");
			iplayer1_3 = new ImageIcon("GAME3_IMG\\redplayer.png");
			iplayer1_4 = new ImageIcon("GAME3_IMG\\redplayer.png");
		...
		//player 1 1
		   ...
		   if(player1_4 == false)
			...
			iplayer2_1 = new ImageIcon("GAME3_IMG\\greenplayer.png");
			iplayer2_2 = new ImageIcon("GAME3_IMG\\greenplayer.png");
			iplayer2_3 = new ImageIcon("GAME3_IMG\\greenplayer.png");
			iplayer2_4 = new ImageIcon("GAME3_IMG\\greenplayer.png");
		...
		if(player2_2 == false)
			...
			iplayer3_1 = new ImageIcon("GAME3_IMG\\yellowplayer.png");
			iplayer3_2 = new ImageIcon("GAME3_IMG\\yellowplayer.png");
			iplayer3_3 = new ImageIcon("GAME3_IMG\\yellowplayer.png");
			iplayer3_4 = new ImageIcon("GAME3_IMG\\yellowplayer.png");
...
//	       player 3 1
			...
			iplayer4_1 = new ImageIcon("GAME3_IMG\\blueplayer.png");
			iplayer4_2 = new ImageIcon("GAME3_IMG\\blueplayer.png");
			iplayer4_3 = new ImageIcon("GAME3_IMG\\blueplayer.png");
			iplayer4_4 = new ImageIcon("GAME3_IMG\\blueplayer.png");
	...
	//player 4 1
			...
			g.setFont(new Font("Italian",Font.BOLD,30));	
			g.setColor(Color.red);
			...
			g.setColor(Color.green);
			g.fillRect(620, 115, 260, 60);
			g.setColor(Color.black);
			g.drawString("Player 2",670,90+65);
			
			g.setColor(Color.yellow);
			g.fillRect(620, 180, 260, 60);
			g.setColor(Color.black);
			g.drawString("Player 3",670,90+130);
			
			g.setColor(Color.blue);
			g.fillRect(620, 245, 260, 60);
			g.setColor(Color.black);
			...
			ifirst   =  new ImageIcon("GAME3_IMG\\1st.png");
			isecond  =  new ImageIcon("GAME3_IMG\\2nd.png");
			ithird   =  new ImageIcon("GAME3_IMG\\\3rd.png");
			iforth   =  new ImageIcon("GAME3_IMG\\4th.png");
			if(first == "player1")
			{
...
//			
			if(randomnum == 1)
			{
				...
				label.setIcon(new ImageIcon("GAME3_IMG\\dice1.png"));
				
				
			}
			else if(randomnum == 2)
			{
				label.setIcon(new ImageIcon("GAME3_IMG\\dice2.png"));
				
				
			}
			else if(randomnum == 3)
			{
				label.setIcon(new ImageIcon("GAME3_IMG\\dice3.png"));
				
			}
				
			else if(randomnum == 4)
			{
				label.setIcon(new ImageIcon("GAME3_IMG\\dice4.png"));

			}
				
			else if(randomnum == 5)
			{
				label.setIcon(new ImageIcon("GAME3_IMG\\dice5.png"));
				
			}
				
			else if(randomnum == 6)
			{
				label.setIcon(new ImageIcon("GAME3_IMG\\dice6.png"));
			...
			if(moves == 0)
			{
				...
				{
				label.setIcon(new ImageIcon("GAME3_IMG\\blankdice.png"));
				}
