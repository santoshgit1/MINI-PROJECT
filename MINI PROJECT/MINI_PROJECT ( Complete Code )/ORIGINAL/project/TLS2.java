...
public class TLS2 
{
	...
	JTextField txtName;
	JButton btnCalculator, btnExit, btnReset, TLS2_DateButton;
	private TLS2_DateButton dobButton;
	private TLS2_DateButton asOnButton;
	...
	public TLS2()
	{
		...
		btnExit.setFont(f2); 
        //------------------------------------------------------------------------------
		dobButton = new TLS2_DateButton();
		dobButton.setForeground(Color.blue);
		asOnButton = new TLS2_DateButton();
