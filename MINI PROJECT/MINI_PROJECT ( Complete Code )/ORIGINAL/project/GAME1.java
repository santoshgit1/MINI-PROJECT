...
import java.util.concurrent.TimeUnit;
	...
	public class GAME1 extends JFrame implements KeyListener,ActionListener	   
	{	   
		...
		ImageIcon tree1, tree2, tree3;
		
		int roadmove=0;	 	
		int num1=400, num2=0, num3=0;
		int cxpos1=0,cxpos2=2,cxpos3=4;	
		int score=0, delay=100, speed=90;
		
		int carxpos[]={100,200,300,400,500};	   
		int carypos[]= {-240,-480,-720,-960,-1200};
		
		boolean rightrotate=false, gameover=false, paint=false;
		
		int cypos1=random.nextInt(5), cypos2=random.nextInt(5), cypos3=random.nextInt(5);
		int y1pos=carypos[cypos1], y2pos=carypos[cypos2], y3pos=carypos[cypos3];
		int tree1ypos=400, tree2ypos=-200, tree3ypos=-500, tree4ypos=100, tree5ypos=-300, tree6ypos=500;
		//-----------------------------------------------------------------
		
		public GAME1(String title)	   // CONSTRUCTOR
		{	   
			super(title);	   
		...
		//-----------------------------------------------------------------
		//############## for  road ###################	      
		tree1=new ImageIcon("./GAME1_IMG/tree1.png");	   
		tree1.paintIcon(this, g, 0, tree1ypos);	   
		num1=random.nextInt(500);	   
		tree1ypos+=50;	   
			   
		tree2=new ImageIcon("./GAME1_IMG/tree2.png");	   
		tree2.paintIcon(this, g, 0,tree2ypos );	   
		tree2ypos+=50;	   
			   
		tree3=new ImageIcon("./GAME1_IMG/tree3.png");	   
		...
		//-----------------------------------------------------------------  
			car=new ImageIcon("GAME1_IMG/gamecar1.png");	      
			...
			//-----------------------------------------------------------------   
			//###############  opposite car	################   
			car1=new ImageIcon("GAME1_IMG/gamecar2.png");	   
			car2=new ImageIcon("GAME1_IMG/gamecar3.png");	   
			car3=new ImageIcon("GAME1_IMG/gamecar4.png");	   
