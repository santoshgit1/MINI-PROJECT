...
public class TLS2_DateChooser extends JDialog implements ItemListener, MouseListener, FocusListener, KeyListener, ActionListener 
{
...
//----------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------
    public TLS2_DateChooser(Dialog owner, String title)
    {
        super(owner, title, true);
        construct();
    }
  //----------------------------------------------------------------------------------------------
    public TLS2_DateChooser(Dialog owner) 
    {
        super(owner, true);
        construct();
    }
  //----------------------------------------------------------------------------------------------
    public TLS2_DateChooser(Frame owner, String title) 
    {
        super(owner, title, true);
        construct();
    }
  //----------------------------------------------------------------------------------------------
    public TLS2_DateChooser(Frame owner) 
    {
        super(owner, true);
        construct();
